...
//
//	mockgen -source=repository/interfaces.go -destination=repository/mock/interfaces.mock.gen.go -package=repository
//
...
func (m *MockRepositoryInterface) CreateEstate(ctx context.Context, newEstate *repository.Estate) error {
	m.ctrl.T.Helper()
...
func (m *MockRepositoryInterface) CreateTree(ctx context.Context, newTree *repository.Tree) error {
	m.ctrl.T.Helper()
...
func (m *MockRepositoryInterface) GetEstateByID(ctx context.Context, estateID string) (repository.Estate, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepositoryInterface) GetTreesByEstateIDAndPlotsLocations(ctx context.Context, estateID string) ([]repository.Tree, error) {
	m.ctrl.T.Helper()
